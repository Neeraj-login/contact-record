 ...
 "cells": [
  {
   ...
   "source": [
    ...
    "    FormTitle.config(bg='navajowhite')\n",
    "    FormTitle.pack(side=TOP)\n",
    ...
    "    \n",
    "    #===================LABELS==============================\n",
    "    lbl_title = Label(FormTitle, text=\"Adding New Contacts\", font=('arial', 16), bg=\"gold\",  width = 300)\n",
    "    lbl_title.pack(fill=X)\n",
    "    lbl_firstname = Label(ContactForm, text=\"Firstname\", font=('arial', 14), bd=5)\n",
    "    lbl_firstname.grid(row=0, sticky=W)\n",
    "    lbl_lastname = Label(ContactForm, text=\"Lastname\", font=('arial', 14), bd=5)\n",
    ...
    "    age = Entry(ContactForm, textvariable=AGE,  font=('arial', 14))\n",
    "    age.grid(row=3, column=1)\n",
    "    address = Entry(ContactForm, textvariable=ADDRESS,  font=('arial', 14),relief='ridge')\n",
    "    address.grid(row=4, column=1)\n",
    "    contact = Entry(ContactForm, textvariable=CONTACT,  font=('arial', 14))\n",
    "    contact.grid(row=5, column=1)\n",
    "    \n",
    "\n",
    "    #==================BUTTONS==============================\n",
    "    btn_addcon = Button(ContactForm, text=\"Save\", width=50,font=('arial',7,'bold'),bg='red',bd=5,relief='ridge', command=SubmitData)\n",
    ...
    "    \n",
    "#============================FRAMES======================================\n",
    "Top = Frame(root, width=500, bd=1, relief='groove')\n",
    "Top.pack(side=TOP)\n",
    ...
    "#============================LABELS======================================\n",
    "lbl_title = Label(Top, text=\"Contact Management System\", font=('arial', 16,'bold'),bg='navajowhite', width=500,activebackground='gold')\n",
    "lbl_title.pack(fill=X)\n",
    "\n",
    "#============================ENTRY=======================================\n",
    "lbl_title=Label(TableMargin,text='Developed by Neeraj Maurya',width=40,font=('arial',12,'bold'),bg='white',fg='red')\n",
    ...
    "lbl_title=Label(TableMargin,text='Mob No:-6306129173',font=('arial',12,'bold'),bg='#66ff66',fg='black')\n",
    "lbl_title.pack(side=BOTTOM)\n",
    "lbl_title=Label(TableMargin,text='Email Id:-neerajmauryacse98@gmail.com',font=('arial',12,'bold'),bg='white',fg='firebrick1')\n",
    "lbl_title.pack(side=BOTTOM)\n",
